...
class TestCategorise(unittest.TestCase):
    def test_transaction_types(self):
        ...
        self.assertEqual(
            categorise_transaction(dummy_type(TransactionType.Credit)),
            Category.Cashback,
        )
        self.assertEqual(
            categorise_transaction(dummy_type(TransactionType.Salary)),
            Category.Salary,
        )
        self.assertEqual(
    ...
    def test_transaction_descs(self):
        self.assertEqual(
        ...
        self.assertEqual(
            categorise_transaction(
                dummy_desc("ART MEM VOL NetBank BPAY 38232 9029695526")
            ),
            Category.Investments,
        )
        self.assertEqual(
            categorise_transaction(dummy_desc("AGL Telco Moruya Au")),
            Category.Utilities,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            categorise_transaction(
                dummy_desc("WOOLWORTHS/313 VICTORIA 442720SABBOTSFORD")
            ),
            Category.Groceries,
        )
